...
interface FormCadastroJuridicoReturnConsultaDemandasProps {
...
export function FormCadastroJuridicoReturnConsultaDemandas({ params }: FormCadastroJuridicoReturnConsultaDemandasProps) {
  const pk = params.id;
