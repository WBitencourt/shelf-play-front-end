  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="space-y-2">
        ...
        <Input disabled id="tribunal" {...register('tribunal', { required: true })} placeholder="Tribunal" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="comarca">Comarca</Label>
        <Input disabled id="comarca" {...register('comarca', { required: true })} placeholder="Comarca" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="foro">Foro</Label>
        <Input disabled id="foro" {...register('foro', { required: true })} placeholder="Foro" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="vara">Vara</Label>
        <Input disabled id="vara" {...register('vara', { required: true })} placeholder="Vara" />
      </div>
