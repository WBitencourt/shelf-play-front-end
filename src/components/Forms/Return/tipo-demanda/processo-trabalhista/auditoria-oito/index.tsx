...
interface FormProcessoTrabalhistaReturnAuditoriaOitoProps {
...
export function FormProcessoTrabalhistaReturnAuditoriaOito({ params }: FormProcessoTrabalhistaReturnAuditoriaOitoProps) {
  const pk = params.id;
