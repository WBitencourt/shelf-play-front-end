...
interface FormProcessoTrabalhistaReturnEsteiraOitoProps {
...
export function FormProcessoTrabalhistaReturnEsteiraOito({ params }: FormProcessoTrabalhistaReturnEsteiraOitoProps) {
  const pk = params.id;
