...
interface FormNotificacaoExtrajudicialReturnAuditoriaOitoProps {
...
export function FormNotificacaoExtrajudicialReturnAuditoriaOito({ params }: FormNotificacaoExtrajudicialReturnAuditoriaOitoProps) {
  const pk = params.id;
