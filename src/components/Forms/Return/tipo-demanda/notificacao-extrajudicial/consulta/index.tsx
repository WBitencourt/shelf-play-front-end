...
interface FormNotificacaoExtrajudicialReturnConsultaDemandasProps {
...
export function FormNotificacaoExtrajudicialReturnConsultaDemandas({ params }: FormNotificacaoExtrajudicialReturnConsultaDemandasProps) {
  const pk = params.id;
