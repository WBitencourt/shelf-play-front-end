...
export interface FormTipificacaoReturnExcecaoOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoReturnExcecaoOitoProps {
  params: FormTipificacaoReturnExcecaoOitoParams;
}
...
export function FormTipificacaoReturnExcecaoOito({ params }: FormTipificacaoReturnExcecaoOitoProps) {
  const pk = params.id;
