...
export interface FormTipificacaoReturnConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoReturnConsultaDemandasProps {
  params: FormTipificacaoReturnConsultaDemandasParams;
}
...
export function FormTipificacaoReturnConsultaDemandas({ params }: FormTipificacaoReturnConsultaDemandasProps) {
  const pk = params.id;
