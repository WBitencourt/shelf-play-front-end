...
export interface FormTipificacaoReturnAuditoriaOitoPageParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoReturnAuditoriaOitoPageProps {
  params: FormTipificacaoReturnAuditoriaOitoPageParams;
}
...
export function FormTipificacaoReturnAuditoriaOitoPage({ params }: FormTipificacaoReturnAuditoriaOitoPageProps) {
  const pk = params.id;
