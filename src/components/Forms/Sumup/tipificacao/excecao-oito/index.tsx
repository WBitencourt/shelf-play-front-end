...
export interface FormTipificacaoSumUpExcecaoOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoSumUpExcecaoOitoProps {
  params: FormTipificacaoSumUpExcecaoOitoParams;
}
...
export function FormTipificacaoSumUpExcecaoOito({ params }: FormTipificacaoSumUpExcecaoOitoProps) {
  const pk = params.id;
