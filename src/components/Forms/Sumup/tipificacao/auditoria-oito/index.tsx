...
export interface FormTipificacaoSumUpAuditoriaOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoSumUpAuditoriaOitoProps {
  params: FormTipificacaoSumUpAuditoriaOitoParams;
}
...
export function FormTipificacaoSumUpAuditoriaOito({ params }: FormTipificacaoSumUpAuditoriaOitoProps) {
  const pk = params.id;
