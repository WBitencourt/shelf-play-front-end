...
export interface FormOficioJudicialSumUpConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialSumUpConsultaDemandasProps {
  params: FormOficioJudicialSumUpConsultaDemandasParams;
}
...
export function FormOficioJudicialSumUpConsultaDemandas({ params }: FormOficioJudicialSumUpConsultaDemandasProps) {
  const pk = params.id;
