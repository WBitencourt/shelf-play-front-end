...
export interface FormOficioJudicialSumUpEsteiraClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialSumUpEsteiraClienteProps {
  params: FormOficioJudicialSumUpEsteiraClienteParams;
}
...
export function FormOficioJudicialSumUpEsteiraCliente({ params }: FormOficioJudicialSumUpEsteiraClienteProps) {
  const pk = params.id;
