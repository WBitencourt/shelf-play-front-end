...
export interface FormOficioJudicialSumUpExcecaoClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialSumUpExcecaoClienteProps {
  params: FormOficioJudicialSumUpExcecaoClienteParams;
}
...
export function FormOficioJudicialSumUpExcecaoCliente({ params }: FormOficioJudicialSumUpExcecaoClienteProps) {
  const pk = params.id;
