...
export interface FormOficioJudicialSumUpExcecaoOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialSumUpExcecaoOitoProps {
  params: FormOficioJudicialSumUpExcecaoOitoParams;
}
...
export function FormOficioJudicialSumUpExcecaoOito({ params }: FormOficioJudicialSumUpExcecaoOitoProps) {
  const pk = params.id;
