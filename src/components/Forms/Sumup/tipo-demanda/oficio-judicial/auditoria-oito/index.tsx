...
export interface FormOficioJudicialSumUpAuditoriaOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialSumUpAuditoriaOitoProps {
  params: FormOficioJudicialSumUpAuditoriaOitoParams;
}
...
export function FormOficioJudicialSumUpAuditoriaOito({ params }: FormOficioJudicialSumUpAuditoriaOitoProps) {
  const pk = params.id;
