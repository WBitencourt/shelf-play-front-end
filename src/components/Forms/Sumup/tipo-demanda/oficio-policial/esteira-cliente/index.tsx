...
export interface FormOficioPolicialSumUpEsteiraClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialSumUpEsteiraClienteProps {
  params: FormOficioPolicialSumUpEsteiraClienteParams;
}
...
export function FormOficioPolicialSumUpEsteiraCliente({ params }: FormOficioPolicialSumUpEsteiraClienteProps) {
  const pk = params.id;
  ...
  const enviarExcecaoCliente = async () => {
    try {
      await actions.backend.demanda.enviarDemandaExcecaoCliente({
        pk, 
