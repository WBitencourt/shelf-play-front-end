...
export interface FormOficioPolicialSumUpConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialSumUpConsultaDemandasProps {
  params: FormOficioPolicialSumUpConsultaDemandasParams;
}
...
export function FormOficioPolicialSumUpConsultaDemandas({ params }: FormOficioPolicialSumUpConsultaDemandasProps) {
  const pk = params.id;
