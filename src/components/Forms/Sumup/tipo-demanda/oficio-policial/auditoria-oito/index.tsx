...
export interface FormOficioPolicialSumUpAuditoriaOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialSumUpAuditoriaOitoProps {
  params: FormOficioPolicialSumUpAuditoriaOitoParams;
}
...
export function FormOficioPolicialSumUpAuditoriaOito({ params }: FormOficioPolicialSumUpAuditoriaOitoProps) {
  const pk = params.id;
