...
export interface FormOficioPolicialSumUpExcecaoOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialSumUpExcecaoOitoProps {
  params: FormOficioPolicialSumUpExcecaoOitoParams;
}
...
export function FormOficioPolicialSumUpExcecaoOito({ params }: FormOficioPolicialSumUpExcecaoOitoProps) {
  const pk = params.id;
