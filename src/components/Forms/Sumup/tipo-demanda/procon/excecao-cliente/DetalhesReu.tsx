...
const DetalhesReuComponent = ({ formBag }: DetalhesReuProps) => {
  ...
  const { formState, setValue, getValues, setError, clearErrors, control } = formBag;
      ...
      <FieldMessage.Error.Root>
        ...
        <div
          className={cn(
            ...
            formState.errors.lista_reus ? 'border border-red-500' : ''
          )}>
          <div>
                  ...
                  {values.lista_reus.map((reuItem) => (
                    <div
                      ...
                      <button
                        ...
                        disabled
                        className="p-1 hover:bg-red-100 rounded-full transition-colors group disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        <FieldMessage.Error.Text visible={!!formState.errors.lista_reus}>
          {formState.errors.lista_reus?.message}
