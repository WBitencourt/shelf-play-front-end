...
interface FormCadastroJuridicoSumUpExcecaoClienteProps {
...
export function FormCadastroJuridicoSumUpExcecaoCliente({ params }: FormCadastroJuridicoSumUpExcecaoClienteProps) {
  const pk = params.id;
