...
interface FormCadastroJuridicoSumUpAuditoriaOitoProps {
...
export function FormCadastroJuridicoSumUpAuditoriaOito({ params }: FormCadastroJuridicoSumUpAuditoriaOitoProps) {
  const pk = params.id;
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="flex justify-center space-x-2">
                  ...
                  >
                    { isJustificandoEnvio ? 'Reprovando...' : 'Reprovar' }
                  </Button>
                </div>
