...
interface FormCadastroJuridicoSumUpConsultaDemandasProps {
...
export function FormCadastroJuridicoSumUpConsultaDemandas({ params }: FormCadastroJuridicoSumUpConsultaDemandasProps) {
  const pk = params.id;
