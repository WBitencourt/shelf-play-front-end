...
interface FormCadastroJuridicoSumUpExcecaoOitoProps {
...
export function FormCadastroJuridicoSumUpExcecaoOito({ params }: FormCadastroJuridicoSumUpExcecaoOitoProps) {
  const pk = params.id;
  ...
  const handleClickEnviarEsteiraOito = () => {
    ...
    updateDialogJustificarEnvioInfo({
      ...
      title: {
        text: 'Justificar envio para estação oito',
      },
    });
  };
