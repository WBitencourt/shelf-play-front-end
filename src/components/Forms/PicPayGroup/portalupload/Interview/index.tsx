...
interface FormInterviewPortalUploadPicPayGroupProps extends HtmlHTMLAttributes<HTMLFormElement>{
  interviewID: string;
}
...
export function FormInterviewPortalUploadPicPayGroup({ interviewID, ...props }: FormInterviewPortalUploadPicPayGroupProps) {
  ...
  description: error?.message ?? 'Página não carregou corretamente',
    ...
    loadPage();
  }, [interviewID, portalUpload.filesPendingInterview, router])
