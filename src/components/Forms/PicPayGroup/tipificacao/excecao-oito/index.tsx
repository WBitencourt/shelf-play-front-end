...
interface FormTipificacaoPicPayGroupExcecaoOitoPageProps {
  params: FormTipificacaoPicPayGroupExcecaoOitoPageParams;
}
...
export function FormTipificacaoPicPayGroupExcecaoOitoPage({ params }: FormTipificacaoPicPayGroupExcecaoOitoPageProps) {
  const pk = params.id;
  ...
  const enviarEsteiraOito = async () => {
    try {
      ...
      const response = await enviarDemandaTipificacaoOito({
        pk,
        justificativa: justificarEnvioDialogInfo.justificativa.value ?? '',
      });
