...
export interface FormTipificacaoPicPayGroupConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormTipificacaoPicPayGroupConsultaDemandasProps {
  params: FormTipificacaoPicPayGroupConsultaDemandasParams;
}
...
export function FormTipificacaoPicPayGroupConsultaDemandas({ params }: FormTipificacaoPicPayGroupConsultaDemandasProps) {
  const pk = params.id;
