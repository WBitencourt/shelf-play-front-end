...
export interface TipificacaoPicPayGroupEsteiraOitoPageParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface TipificacaoPicPayGroupEsteiraOitoPageProps {
  params: TipificacaoPicPayGroupEsteiraOitoPageParams;
}
...
export function TipificacaoPicPayGroupEsteiraOitoPage({ params }: TipificacaoPicPayGroupEsteiraOitoPageProps) {
  const pk = params.id;
