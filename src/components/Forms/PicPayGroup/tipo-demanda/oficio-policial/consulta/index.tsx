...
export interface FormOficioPolicialPicPayGroupConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialPicPayGroupConsultaDemandasProps {
  params: FormOficioPolicialPicPayGroupConsultaDemandasParams;
}
...
export function FormOficioPolicialPicPayGroupConsultaDemandas({ params }: FormOficioPolicialPicPayGroupConsultaDemandasProps) {
  const pk = params.id;
