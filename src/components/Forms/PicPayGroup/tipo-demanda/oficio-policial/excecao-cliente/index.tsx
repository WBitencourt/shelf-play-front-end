...
export interface FormOficioPolicialPicPayGroupExcecaoClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialPicPayGroupExcecaoClienteProps {
  params: FormOficioPolicialPicPayGroupExcecaoClienteParams;
}
...
export function FormOficioPolicialPicPayGroupExcecaoCliente({ params }: FormOficioPolicialPicPayGroupExcecaoClienteProps) {
  const pk = params.id;
  ...
  const onSubmit = async (data: DadosDemandaOficioPolicial) => {
    try {
