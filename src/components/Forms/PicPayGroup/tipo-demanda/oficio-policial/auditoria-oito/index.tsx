...
export interface FormOficioPolicialPicPayGroupAuditoriaOitoParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialPicPayGroupAuditoriaOitoProps {
  params: FormOficioPolicialPicPayGroupAuditoriaOitoParams;
}
...
export function FormOficioPolicialPicPayGroupAuditoriaOito({ params }: FormOficioPolicialPicPayGroupAuditoriaOitoProps) {
  const pk = params.id;
