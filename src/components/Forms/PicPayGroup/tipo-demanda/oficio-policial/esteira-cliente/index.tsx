...
export interface FormOficioPolicialPicPayGroupEsteiraClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioPolicialPicPayGroupEsteiraClienteProps {
  params: FormOficioPolicialPicPayGroupEsteiraClienteParams;
}
...
export function FormOficioPolicialPicPayGroupEsteiraCliente({ params }: FormOficioPolicialPicPayGroupEsteiraClienteProps) {
  const pk = params.id;
