...
export interface FormCitacaoIntimacaoPicPayGroupConsultaDemandas {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormCitacaoIntimacaoPicPayGroupConsultaDemandasProps {
  params: FormCitacaoIntimacaoPicPayGroupConsultaDemandas;
}
...
export function FormCitacaoIntimacaoPicPayGroupConsultaDemandas({ params }: FormCitacaoIntimacaoPicPayGroupConsultaDemandasProps) {
  const pk = params.id;
  ...
  const formatFormValues = useCallback((values: Partial<DemandaCitacaoIntimacaoPicPay>) => {
  ...
  const updateFormValues = useCallback((newValues: Partial<DemandaCitacaoIntimacaoPicPay>) => {
    try {
  ...
  const onSubmit = async (dados: DemandaCitacaoIntimacaoPicPay) => {
    try {
