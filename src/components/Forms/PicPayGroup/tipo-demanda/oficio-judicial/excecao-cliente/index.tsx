...
export interface FormOficioJudicialPicPayGroupExcecaoClienteParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialPicPayGroupExcecaoClienteProps {
  params: FormOficioJudicialPicPayGroupExcecaoClienteParams;
}
...
export function FormOficioJudicialPicPayGroupExcecaoCliente({ params }: FormOficioJudicialPicPayGroupExcecaoClienteProps) {
  const pk = params.id;
