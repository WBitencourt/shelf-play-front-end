...
export interface FormOficioJudicialPicPayGroupConsultaDemandasParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialPicPayGroupConsultaDemandasProps {
  params: FormOficioJudicialPicPayGroupConsultaDemandasParams;
}
...
export function FormOficioJudicialPicPayGroupConsultaDemandas({ params }: FormOficioJudicialPicPayGroupConsultaDemandasProps) {
  const pk = params.id;
