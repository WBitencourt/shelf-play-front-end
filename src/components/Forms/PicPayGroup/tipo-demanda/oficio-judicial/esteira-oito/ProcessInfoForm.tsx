  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="space-y-2">
        ...
        <Input id="tribunal" {...register('tribunal')} placeholder="Tribunal" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="comarca">Comarca</Label>
        <Input id="comarca" {...register('comarca')} placeholder="Comarca" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="foro">Foro</Label>
        <Input id="foro" {...register('foro')} placeholder="Foro" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="vara">Vara</Label>
        <Input id="vara" {...register('vara')} placeholder="Vara" />
      </div>
    </div>
  );
}
