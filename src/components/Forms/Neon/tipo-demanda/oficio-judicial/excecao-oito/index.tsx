...
export interface FormOficioJudicialNeonExcecaoOitoPageParams {
  id: string;
  esteira: string;
  esteiraTipo: string;
...
interface FormOficioJudicialNeonExcecaoOitoPageProps {
  params: FormOficioJudicialNeonExcecaoOitoPageParams;
}
...
export function FormOficioJudicialNeonExcecaoOitoPage({ params }: FormOficioJudicialNeonExcecaoOitoPageProps) {
  const pk = params.id;
