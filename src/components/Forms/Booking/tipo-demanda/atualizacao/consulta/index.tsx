...
interface FormAtualizacaoBookingConsultaDemandasProps {
...
export function FormAtualizacaoBookingConsultaDemandas({ params }: FormAtualizacaoBookingConsultaDemandasProps) {
  const pk = params.id;
      ...
      >
        ...
        >
          ...
          <div className="text-sm">
            <p>Atenção! Ao habilitar o despacho, todos os outros campos (Liminar, Contestação, Audiência e Sentença) serão <strong>limpos e desabilitados</strong>.</p>
            <p className="mt-2 font-medium">O despacho só pode ser utilizado quando nenhum outro campo estiver preenchido.</p>
