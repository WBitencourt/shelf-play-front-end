...
interface FormAtualizacaoBookingEsteiraOitoProps {
...
export function FormAtualizacaoBookingEsteiraOito({ params }: FormAtualizacaoBookingEsteiraOitoProps) {
  const pk = params.id;
                ...
                <div>
                  ...
                  <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3">
                              <Input
                                type="text"
                                placeholder="Prazo"
                                className="w-24 p-2 border rounded-md text-sm text-gray-700 dark:text-gray-300"
                    ...
                    <div className="bg-purple-50 dark:bg-purple-950/30 p-3 rounded-md">
                      ...
                      {/* {values.contestacao_habilitada && (
                        <div className="space-y-3 mt-2">
                          <div>
                            <Label className="block text-sm mb-1">Conteúdo da contestação</Label>
                            <Textarea 
                              id="conteudo_contestacao" 
                              {...formBag.register('conteudo_contestacao')} 
                              rows={3} 
