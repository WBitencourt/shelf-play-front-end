...
export function FormCadastroJuridicoBookingAuditoriaOito({ params }: FormCadastroJuridicoBookingAuditoriaOitoProps) {
  ...
  const defaultCamposAuditados: CamposAuditadosCadastroJuridico = {
    ...
    defaultValues: async () => {
      if (dadosIniciais) {
        return {
          ...
          tipificacao: dadosIniciais.tipificacao || '',
          desdobramento: dadosIniciais.desdobramento || false,
          processo_originario: dadosIniciais.processo_originario || '',
          nome_desdobramento: dadosIniciais.nome_desdobramento || '',
          tipo_acao: dadosIniciais.tipo_acao || 'Indenizatória',
          acao: dadosIniciais.acao || 'Indenizatória',
          tipo_acao2: dadosIniciais.tipo_acao2 || '',
          procedimento: dadosIniciais.procedimento || '',
          uf: dadosIniciais.uf || '',
          cidade: dadosIniciais.cidade || '',
          orgao_tribunal: dadosIniciais.orgao_tribunal || '',
          processo: dadosIniciais.processo || '',
          objeto: dadosIniciais.objeto || '',
          lista_pedidos: dadosIniciais.lista_pedidos || [],
          data_distribuicao: dadosIniciais.data_distribuicao || '',
          resumo_processo: dadosIniciais.resumo_processo || '',
          causa_raiz: dadosIniciais.causa_raiz || '',
          sub_causa_raiz: dadosIniciais.sub_causa_raiz || '',
          prazo_liminar: dadosIniciais.prazo_liminar || '',
          prazo_tipo: dadosIniciais.prazo_tipo || 'dias_corridos',
          prazo_contestacao: dadosIniciais.prazo_contestacao || '',
          data_audiencia: dadosIniciais.data_audiencia || '',
          lista_autores: dadosIniciais.lista_autores || [],
          lista_reus: dadosIniciais.lista_reus || [],
          valor_causa: dadosIniciais.valor_causa
            ? maskCurrencyBRL(dadosIniciais.valor_causa.toString())
            : maskCurrencyBRL('0'),
          campos_auditados: defaultCamposAuditados,
          conteudo_liminar: dadosIniciais.conteudo_liminar || '',
        };
      }
      return {
        observacao: [],
  ...
  useEffect(() => {
    if (dadosIniciais) {
      ...
      console.log('Valor de sub_causa_raiz:', dadosIniciais.sub_causa_raiz);
  ...
  const formatFormValues = useCallback((values: Partial<DemandaCadastroJuridico>) => {
    ...
    formattedValues.campos_auditados = defaultCamposAuditados;
  ...
  const validarCamposAuditados = () => {
    const camposAuditaveis = values?.campos_auditados as CamposAuditadosCadastroJuridico;
  ...
  const AlertaCampoAuditado = ({ value }: { value: boolean | undefined }) => {
    if (value === undefined) {
          ...
          {isLoadingForm ? (
            ...
            <form
                ...
                <div className="space-y-4 bg-blue-50 dark:bg-blue-950/30 p-3 rounded-md">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      ...
                      />
                      <Input type="checkbox" className="sr-only" disabled checked={values.desdobramento} />
                    </div>
                  </div>
                ...
                <div className="space-y-4 bg-green-50 dark:bg-green-950/30 p-3 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => formBag.setValue('orgao_tribunal', value)}>
                      <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="group flex gap-2 items-center">
                        ...
                        <div className="ml-2 flex gap-2">
                          <ThumbsUp
                            data-active={values?.campos_auditados?.data_audiencia === true}
                            className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[active=true]:text-green-500 hover:text-green-500"
                            onClick={() => formBag.setValue('campos_auditados.data_audiencia', true)}
                          />
                          <ThumbsDown
                            data-inactive={values?.campos_auditados?.data_audiencia === false}
                            className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[inactive=true]:text-red-500 hover:text-red-500"
                            onClick={() => formBag.setValue('campos_auditados.data_audiencia', false)}
                          />
                        </div>
                      </div>
                      <div className="flex flex-col gap-2">
                        <AlertaCampoAuditado value={values?.campos_auditados?.data_audiencia} />
                      </div>
                    </div>
              ...
              <div className="flex-1 border-t border-gray-200">
                ...
                <div className="flex flex-col gap-2 bg-purple-50 dark:bg-purple-950/30 p-3 rounded-md">
                  <div className="flex flex-1 gap-2">
                    ...
                    <div className="flex items-end justify-center gap-2 py-2 pl-2 pr-0">
                      <ThumbsUp
                        data-active={values?.campos_auditados?.lista_autores === true}
                        className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[active=true]:text-green-500 hover:text-green-500"
                        onClick={() => formBag.setValue('campos_auditados.lista_autores', true)}
                      />
                      <ThumbsDown
                        data-inactive={values?.campos_auditados?.lista_autores === false}
                        className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[inactive=true]:text-red-500 hover:text-red-500"
                        onClick={() => formBag.setValue('campos_auditados.lista_autores', false)}
                      />
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    <AlertaCampoAuditado value={values?.campos_auditados?.lista_autores} />
                  </div>
                </div>
              </div>
                            ...
                            <div
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 rounded text-xs text-nowrap">
                                    {reu.documento}
                                  </span>
                                </div>
                              </div>
              ...
              <div className="pt-4 border-t border-gray-200 ">
                ...
                <div className="space-y-4 bg-cyan-50 dark:bg-cyan-950/30 p-3 rounded-md">
                  <div>
                    <Select onValueChange={(value) => formBag.setValue('objeto', value)} value={values.objeto}>
                  ...
                  <div className="flex flex-col gap-2">
                    <Label className="block text-sm">Número da reserva</Label>
                    <div className="group flex gap-2 items-center">
                      <Input
                        disabled
                        type="text"
                      ...
                      <div className="ml-2 flex gap-2">
                        <ThumbsUp
                          data-active={values?.campos_auditados?.numero_reserva === true}
                          className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[active=true]:text-green-500 hover:text-green-500"
                          onClick={() => formBag.setValue('campos_auditados.numero_reserva', true)}
                        />
                        <ThumbsDown
                          data-inactive={values?.campos_auditados?.numero_reserva === false}
                          className="w-4 h-4 hover:scale-125 cursor-pointer text-gray-400 data-[inactive=true]:text-red-500 hover:text-red-500"
                          onClick={() => formBag.setValue('campos_auditados.numero_reserva', false)}
                        />
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                      <AlertaCampoAuditado value={values?.campos_auditados?.numero_reserva} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 bg-indigo-50 dark:bg-indigo-950/30 p-3 rounded-md">
                  <div className="space-y-2">
                    ...
                    <Select value={pedidos.descricao} onValueChange={(value) => updatePedidos({ descricao: value })}>
                      <SelectTrigger>
                  ...
                  <button
                    type="button"
                    disabled
                    className="w-full bg-indigo-500 text-white px-4 py-2 rounded-md text-sm hover:bg-indigo-600 transition-colors flex items-center justify-center gap-2 disabled:cursor-not-allowed">
                    <Plus className="w-4 h-4" />
                    Adicionar pedido
                  </button>
                ...
                <div className="space-y-4 bg-rose-50 dark:bg-rose-950/30 p-3 rounded-md">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => formBag.setValue('causa_raiz', value)}>
                      <SelectTrigger>
              ...
              <div className="flex justify-center space-x-2">
                <Button type="submit" className="bg-green-700" disabled={isAprovandoForm}>
                  {isAprovandoForm ? 'Aprovando...' : 'Aprovar'}
                </Button>

                <Button type="button" className="bg-red-700" disabled={isReprovandoForm} onClick={handleClickReprovar}>
