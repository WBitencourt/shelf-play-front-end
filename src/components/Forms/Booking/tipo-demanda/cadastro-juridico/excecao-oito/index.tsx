...
interface FormCadastroJuridicoBookingExcecaoOitoProps {
...
export function FormCadastroJuridicoBookingExcecaoOito({ params }: FormCadastroJuridicoBookingExcecaoOitoProps) {
  const pk = params.id;
