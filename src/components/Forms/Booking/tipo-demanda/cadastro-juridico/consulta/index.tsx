...
interface FormCadastroJuridicoBookingConsultaDemandasProps {
...
export function FormCadastroJuridicoBookingConsultaDemandas({
  params,
}: FormCadastroJuridicoBookingConsultaDemandasProps) {
  const pk = params.id;
  ...
  const handleSelecionarProcesso = async (processoInfo: ProcessoInfo) => {
    // Removendo código comentado que não está sendo utilizado
  };
